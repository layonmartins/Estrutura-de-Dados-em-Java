...
public abstract class AbstractBinaryTree<E> extends AbstractTree<E>
  ...
  public Iterable<Position<E>> inorder() {
	...
	/** Método criado para percorrer a arvore em Posorder */
	private void PosorderSubtree(Position<E> p, List<Position<E>> snapshot) {
   	 	if (left(p) != null)
      		PosorderSubtree(left(p), snapshot);
   		if (right(p) != null)
     		 PosorderSubtree(right(p), snapshot);
		snapshot.add(p);
 	}
	...
	/** Método criado para percorrer a arvore em Preorder */
