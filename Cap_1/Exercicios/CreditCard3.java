...
public class CreditCard3{
	...
	public void makePayment(double payment, java.util.Date vencimento) { //Faz um pagamento
	...
	public static void printCard(CreditCard3 c) { //Imprime informações sobre o cartão
	...
	public static void main(String[] args){
		CreditCard3 bancoke = new CreditCard3("BK01", "Layon Martins",  "Bancoke", 1000.0, 4000);
