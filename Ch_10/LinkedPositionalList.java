...
public class LinkedPositionalList<E> implements PositionalList<E> {
  ...
  public String toString() {
	...
	/** metodo que retorna um elemento passando uma posição */
	public E get(Position<E> p){
		return validate(p).getElement();
	}
	...
	public static void main(String[] args){
		...
		PositionalList<String> lista = new LinkedPositionalList<String>();
		lista.addLast("A");
		lista.addLast("B");
		lista.addLast("C");
		...
		for(Position<String> p: lista.positions())
