...
public class HeapPriorityQueue<K,V> extends AbstractPriorityQueue<K,V> {
  ...
  protected boolean hasLeft(int j) { return left(j) < heap.size(); } //entendi
  protected boolean hasRight(int j) { return right(j) < heap.size(); } //se for > q size e falso
  ...
  protected void downheap(int j) {
    while (hasLeft(j)) {               // continue to bottom (or break statement)
      ...
      } //até aqui ele vai ter o menor dos filhos
 ...
 /** Sorts sequence S, using initially empty priority queue P to produce the orde. */
